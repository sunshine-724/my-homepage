...
- **Web版,IOS版の実装(Kotlin)**  
  パソコンのJava版をベースに、Web版とiOS版の実装を行いました。開発期間はおよそ4週間です。  
  Kotlin Multiplatformを使用してクロスプラットフォームのアプリケーションを開発し、IntelliJ IDEAでコーディングを行いました。
- **プロジェクトマネージャー**  
...
🔗 [Web版スピロデザインはこちら](https://sunshine-724.github.io/SpiroDesignAll/)
