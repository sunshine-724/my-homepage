...
const testFiles : string[] = ["introduction/iloveimgResized/picture.png","introduction/iloveimgResized/picture2.png","introduction/iloveimgResized/picture3.JPG","introduction/iloveimgResized/picture4.jpg","introduction/iloveimgResized/picture5.png"]

export default function Top() {
  return (
    <>
        <MediaSwiper files={testFiles}></MediaSwiper>
